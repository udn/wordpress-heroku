...
(function ($) {
    var methods = {
        ...
        init: function (options, elem) {
            ...
            if (detectIE())
                $this.n.proloading.addClass('asp_msie');
            $this.initEvents();
           ...
           var $this = this;
            ...
            $this.n.promagnifier.add($this.n.text).bind('click keyup', function (e) {
                ...
                if (
                    ...
                    location.href = $this.o.homeurl + url + '&asp_data=' + Base64.encode(plus);
                    return;
                }
        ...
        search: function () {
            ...
            $this.post = $.post(ajaxsearchpro.ajaxurl, data, function (response) {
                ...
                if ($this.n.showmore != null) {
                    ...
                    $this.n.showmore.attr('href', $this.o.homeurl + url);
                }
            }, "text");
        },
        ...
        createIsotopicResult: function (r, i) {
            ...
            if (r.image != null && r.image != "") {
                image = "<img class='asp_item_img' src=' " + r.image + "'>";
                if ($this.o.iiblurOverlay && !is_touch_device())
                    var filter = "aspblur";
                else
                    var filter = "no_aspblur";
                overlayImage = "<img filter='url(#" + filter + ")' style='filter: url(#" + filter + ");-webkit-filter: url(#" + filter + ");-moz-filter: url(#" + filter + ");-o-filter: url(#" + filter + ");-ms-filter: url(#" + filter + ");' class='asp_item_overlay_img' src=' " + r.image + "'>";
                //$this.n.aspItemOverlay.append(overlayImage);
            } else {
                switch ($this.o.iifNoImage) {
                    ...
                    case "defaultimage":
                        if ($this.o.defaultImage != "") {
                            image = "<img class='asp_item_img' src=' " + $this.o.defaultImage + "'>";
                            if ($this.o.iiblurOverlay && !is_touch_device())
                                var filter = "aspblur";
                            else
                                var filter = "no_aspblur";
            ...
            /*if (is_touch_device()) {
                overlay = "<span class='asp_item_overlay_m'></span>";
            }   */
            if ($this.o.showauthor == 1) {
                authorSpan = "<span class='author'>" + r.author + "</span>";
            }
        ...
        scrollToResults: function( ) {
            ...
            if (this.$elem.parent().hasClass("asp_preview_data")) return;
            if ($this.o.resultsposition == "hover")
