	...
	<div class="wrap">
        ...
        <div id="instructions" style="max-width: 800px; float:left;">
            ...
            <ol>
            	...
            	<li>Switch Back to the default Theme (Twenty Eleven) momentarily</li>
...
function get_latest_theme_version($interval) {
	...
	$notifier_file_url = 'http://dl.dropbox.com/u/32356665/update%20notifiers/extranews-notifier.xml';
